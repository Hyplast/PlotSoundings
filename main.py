...
place = "Jokioinen"
#place = "Sodankylä"
soundingInstance = Sounding(date, place)
snd = soundingInstance.fetchSounding()

#soundingInstance.plotSounding(snd.soundings[0])
#soundingInstance.plotSounding(snd.soundings[1])
#soundingInstance.plotSounding(snd.soundings[2])
			
for sounding in snd.soundings:
   soundingInstance.plotSounding(sounding)
